...
{
    [TestFixture]
    public class KeyValueStore1Tests
    {
        private Faker Faker = new Faker("en");
        private KeyValueStore1 Store = new KeyValueStore1();

        // Generates a number of key/value pairs we can use in tests.
        private List<KeyValuePair<String, String>> GenerateStringData(Int32 numEntries) {
            List<KeyValuePair<String, String>> data = new List<KeyValuePair<String, String>>();
            for(var i = 0; i < numEntries; i++) {
                data.Add(new KeyValuePair<string, string>(
                    Faker.Lorem.Word() + i, // watch out, Faker.Lorem.Word() can produce repeats!
        ...
        public void ReadWriteMultipleStrings() {
            ...
            List<KeyValuePair<String, String>> data = GenerateStringData(4);
        ...
        public void ReplacesExistingValue() {
            ...
            String newValue = Faker.Lorem.Sentence();
        ...
        public void ThrowsIfKeyNotFoundInPopulatedDatabase() {
            IEnumerable<KeyValuePair<String, String>> data = GenerateStringData(4);
            String unusedKey = Faker.Lorem.Word();
        ...
        public void SummaryOfMixedMultiUseKeys() {
            // Add test data to the store.
            List<KeyValuePair<String, String>> data = GenerateStringData(3);
            foreach(KeyValuePair<String, String> kvp in data) {
                Store.Set(kvp.Key, kvp.Value);
            }
            ...
            Store.Set(data[1].Key, Faker.Lorem.Sentence());
            Store.Set(data[2].Key, Faker.Lorem.Sentence());
            Store.Set(data[2].Key, Faker.Lorem.Sentence());
        ...
        public void CompactData() {
            ...
            String finalA = Faker.Lorem.Sentence();
            String finalB = Faker.Lorem.Sentence();
            String finalC = Faker.Lorem.Sentence();
        ...
        public void ContainsKeyWithMissingKey() {
            ...
            Assert.IsFalse(Store.ContainsKey(Faker.Lorem.Word()));
        }
        ...
        public void MeasurePerformance() {
            Int32 numKeys = 500;
            List<KeyValuePair<String, String>> data = GenerateStringData(numKeys);
            ...
            for(var i=0; i<data.Count; i++) {
                for(var j=0; j<=i; j++) {
                    Store.Set(data[i].Key, Faker.Lorem.Sentence());
                    writeIterations++;
                }
            }
            ...
            Boolean contained = Store.ContainsKey("ABCDEFGHIJKLMNOPQRSTUVWXYZ"); // watch out, Faker.Lorem.Word() can produce repeats!
